...
- Name: auth.spec.ts >> Auth checks for all roles >> area-in-charge can land on correct dashboard
...
- generic [ref=e5]:
  - generic [ref=e6]:
    - generic [ref=e7]:
      - generic [ref=e8]: Est. Registry · Institutional Access
      - heading [level=1] [ref=e9]:
        - text: Accreditation
        - emphasis [ref=e10]: Management
        - text: System
      - paragraph [ref=e11]: The system of record for institutional review, self-study submissions, and site-visit documentation.
      - list [ref=e12]:
        - listitem [ref=e13]:
          - generic [ref=e14]: "01"
          - text: Your Pathway to Accreditation Success
        - listitem [ref=e15]:
          - generic [ref=e16]: "02"
          - text: Self-Study Workspace
        - listitem [ref=e17]:
          - generic [ref=e18]: "03"
          - text: Site Visit Records
    - paragraph [ref=e19]: ADAMS © 2026 · Confidential institutional record
  - generic [ref=e21]:
    - img "ADAMS Logo" [ref=e22]
    - heading "Sign in to your account" [level=2] [ref=e23]
    - paragraph [ref=e24]: Use your institutional credentials to continue.
    - generic [ref=e25]:
      - generic [ref=e26]:
      ...
      - generic [ref=e51] [cursor=pointer]: Create an account
